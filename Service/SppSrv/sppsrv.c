...
static void srv_spp_init_event_hdler(void)
{
    ...
    /*----------------------------------------------------------------*/
/*
	eventMask = MSG_ID_BT_SPP_ACTIVATE_CNF|
...
//hej
U32 test_srv_spp_read(U32 conn_id, void* buf, U32 size)
{
	/*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/	
...
//hej
void send_spp_test_byaplex(U32 conn_id)
 {
	CHAR buf[] = "hello";
	UART_CTRL_OWNER_T port_owner;
	UART_CTRL_PUT_BYTES_T data;
	...
	if(conn==NULL)
	{
		kal_prompt_trace(MOD_XDM, "------send_spp_test--------conn ret=NULL FAIL");
	}
	else
	{
		kal_prompt_trace(MOD_XDM, "------send_spp_test--------conn SUCESS connid=%d", conn->conn_id);
	}
...
void send_spp_byaplex(U32 conn_id, char* buff, int len)
{
	//CHAR buf[] = "hello";
	UART_CTRL_OWNER_T port_owner;
	UART_CTRL_PUT_BYTES_T data;
...
//hej
U32 test_srv_spp_write(U32 conn_id, void* buf, U32 size)
{
    /*----------------------------------------------------------------*/
    /* Local Variables                                                */
    /*----------------------------------------------------------------*/	
...
//hej
static S32 my_spps_event_handler(U32 event, void* para)
{
	kal_prompt_trace(MOD_XDM, "-------my_spps_event_handler--------event=%d", event);
	
}
//hej
void set_spp_callback(SppHandle handle)
{
	U32 eventMask;
	eventMask = MSG_ID_BT_SPP_ACTIVATE_CNF|
				MSG_ID_BT_SPP_DEACTIVATE_CNF|
	...
	//srv_spp_set_notify_hdlr(handle, eventMask, my_spps_event_handler, NULL);
...
static U8 srv_spp_uart_ready_to_read_ind(void* msg)
{
    ...
    /*----------------------------------------------------------------*/
		    ...
		    kal_prompt_trace(MOD_XDM, "---------srv_spp_uart_ready_to_read_ind-------");
...
static U8 srv_spp_uart_ready_to_write_ind(void * msg)
{
    ...
    kal_prompt_trace(MOD_XDM, "---------srv_spp_uart_ready_to_write_ind-------");
...
static U8 srv_spp_uart_plugout_ind(void* msg)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
	    kal_prompt_trace(MOD_XDM, "---------srv_spp_uart_plugout_ind-------");
...
static U8 srv_spp_uart_set_owner_ind(void* msg)
{
    ...
    /*----------------------------------------------------------------*/
	    ...
	    kal_prompt_trace(MOD_XDM, "---------srv_spp_uart_set_owner_ind-------");
...
static U8 srv_spp_disconnect_ind(void * msg)
{
    ...
    /*----------------------------------------------------------------*/
	    ...
	    kal_prompt_trace(MOD_XDM, "---------srv_spp_disconnect_ind-------");
...
{	
    ...
    kal_prompt_trace(MOD_XDM, "---------srv_spp_port_deactivate_cnf-------");
...
{	
	    kal_prompt_trace(MOD_XDM, "---------srv_spp_audio_connect_cnf-------");

	return MMI_RET_OK;
}
static U8 srv_spp_audio_connect_ind(void* msg)
{
    kal_prompt_trace(MOD_XDM, "---------srv_spp_audio_connect_ind-------");

	return MMI_RET_OK;
}
static U8 srv_spp_audio_disconnect_cnf(void* msg)
{
	kal_prompt_trace(MOD_XDM, "---------srv_spp_audio_disconnect_cnf-------");
	return MMI_RET_OK;
}
static U8 srv_spp_audio_disconnect_ind(void* msg)
{
	kal_prompt_trace(MOD_XDM, "---------srv_spp_audio_disconnect_ind-------");
