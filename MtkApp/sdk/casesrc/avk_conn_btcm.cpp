...
void vs_btcm_start(void)
{
    ...
    kal_prompt_trace(MOD_XDM, "vs_btcm_start");
#ifdef __BT_AUTO_DETECT_SUPPORT__    
    ...
    kal_prompt_trace(MOD_XDM, "vs_btcm_start1");
    ...
    if (0 > sg_vs_btcm_ctx.btcm_hdl)
    {
    	kal_prompt_trace(MOD_XDM, "srv_bt_cm_set_notify failure");
        DS_OUTLOG("srv_bt_cm_set_notify failure");
        ret_b = MMI_FALSE;
    }
    else
    {
    	kal_prompt_trace(MOD_XDM, "srv_bt_cm_set_notify true");
        ret_b = MMI_TRUE;
    }
    ...
    if (srv_bt_cm_is_authentication())
    {
		...
		kal_prompt_trace(MOD_XDM, "srv_bt_cm_is_authentication ret MMI_TRUE");
		...
		kal_prompt_trace(MOD_XDM, "srv_bt_cm_set_authentication ret not SRV_BT_CM_RESULT_SUCCESS");
        }
    }
    ...
    kal_prompt_trace(MOD_XDM, "srv_bt_cm_get_state 1 [%d]", e);
    }
...
#endif                
		kal_prompt_trace(MOD_XDM, "SRV_BT_CM_EVENT_SET_AUTHENTICATION",);
                break;

            case SRV_BT_CM_EVENT_SCO_IND:
			kal_prompt_trace(MOD_XDM, "SRV_BT_CM_EVENT_SCO_IND",);
                vs_btcm_sco_ind_cb(para);
                break;

            case SRV_BT_CM_EVENT_PANIC_IND:
			kal_prompt_trace(MOD_XDM, "SRV_BT_CM_EVENT_PANIC_IND",);
                vs_btcm_panic_ind_pre_process(para);
                break;

            case SRV_BT_CM_EVENT_READ_REMOTE_DEV_NAME:
			kal_prompt_trace(MOD_XDM, "SRV_BT_CM_EVENT_READ_REMOTE_DEV_NAME",);
			...
			kal_prompt_trace(MOD_XDM, "SRV_BT_CM_EVENT_SET_LIMIT_DISCOVERABLE_MODE",);
			...
			kal_prompt_trace(MOD_XDM, "SRV_BT_CM_EVENT_CHIP_DETECT",);
